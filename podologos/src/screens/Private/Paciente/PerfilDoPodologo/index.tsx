...
export default function PerfilDoPodologo() {
  ...
  return (
    <SafeAreaView className="flex w-full bg-branco">
      <Header text="Perfil do podólogo"></Header>
      <ScrollView className="flex px-5 space-y-8">
        ...
        <View className="flex">
          ...
          <Text className="text-cinza font-bold text-[16px] mb-3">
            Superior
          </Text>
          <Text className="text-cinza font-bold text-[16px]">2022</Text>
        </View>
