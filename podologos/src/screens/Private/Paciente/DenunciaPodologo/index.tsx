...
function DenunciaPodologo({route, navigation}) {
  ...
  const radioButtons = useMemo(
    () => [
      ...
      },
      {
        ...
        value: 'Falta de Profissionalismo',
      },
      {
        id: '6',
        label: 'Diagnóstico Errôneo',
        value: 'Diagnóstico Errôneo',
      },
      {
        id: '7',
...
export default DenunciaPodologo;
